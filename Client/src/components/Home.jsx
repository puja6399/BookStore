...
const Home = () => {
  ...
  const deletePost = async (_id) => {
    try {
      const respose = await fetch(`https://bookstore-nl9p.onrender.com/post/${_id}`, {
        method: "POST",
        headers: {
  ...
  const fetchPosts = async () => {
    ...
    if (activeBtn === "ALL") {
      try {
        const response = await fetch("https://bookstore-nl9p.onrender.com/post", {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
          },
      ...
      try {
        const response = await fetch(
          `https://bookstore-nl9p.onrender.com/post/genre/${activeBtn}`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
