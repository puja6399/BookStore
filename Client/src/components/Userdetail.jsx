    ...
    if (currentUser && activeBtn === "MyPosts") {
      try {
        ...
        const response = await fetch(
          `https://bookstore-nl9p.onrender.com/post/userdetail/${currentUser}`,
          {
            method: "GET",
            headers: {
      ...
      try {
        setloading(true);
        const response = await fetch(
          `https://bookstore-nl9p.onrender.com/order/${currentUser}`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
      ...
      try {
        setloading(true);
        const response = await fetch(
          `https://bookstore-nl9p.onrender.com/order/sales/${currentUser}`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
